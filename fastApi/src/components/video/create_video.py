...
def audio2head(audio_path, img_path, model_path, save_path):
    ...
    temp_audio= machineCwd + "/src/components/video/results/temp.wav"
    ...
    config_file = r"./src/components/video/config/vox-256.yaml"
    ...
    opt = argparse.Namespace(**yaml.safe_load(open("./src/components/video/config/parameters.yaml")))
